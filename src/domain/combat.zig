...
// Re-export from combat/state.zig - see doc/decomposition.md for refactor notes
const state_mod = @import("combat/state.zig");
pub const CombatZone = state_mod.CombatZone;
...
test "Agent.isPoolCardAvailable respects cooldowns" {
    ...
    // Note: isPoolCardAvailable moved to Agent (checks both pool membership and cooldowns)
    // TODO: Implement test
