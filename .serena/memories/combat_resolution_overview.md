...
- `tuning.zig` re-exports all gameplay-affecting constants (hit chance modifiers, condition penalties, guard coverage bonuses) as a central reference for balance tuning. See memory `random_streams_and_tuning` for details.
